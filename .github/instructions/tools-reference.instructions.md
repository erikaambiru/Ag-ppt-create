...
# 4. layouts.json に content_with_image マッピングを追加（手動または自動）
# Two Column レイアウト（Layout 5 or 6）を content_with_image にマッピング
```
...
```json
{
  "layout_mapping": {
    "title": 1,
    "content": 3,
    "content_with_image": 6,  // ★ 追加: Two Column Non-bulleted text
    "section": 42,
    "two_column": 5,
    "photo": 15,
    ...
